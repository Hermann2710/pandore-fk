      ...
      >
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span className="text-foreground font-medium">
            {activeCategoryName ?? t("allProducts")}
          </span>
        </div>
      ...
      >
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-9 h-10 bg-muted/50 border-0 focus-visible:ring-1 focus-visible:ring-ring"
          />
        </div>

        <Select value={category} onValueChange={setCategory}>
          <SelectTrigger className="w-full sm:w-52 h-10 bg-muted/50 border-0 focus:ring-1 focus:ring-ring">
        ...
        <Select value={ordering} onValueChange={setOrdering}>
          <SelectTrigger className="w-full sm:w-48 h-10 bg-muted/50 border-0 focus:ring-1 focus:ring-ring">
      ...
      {!isLoading && products && (
        ...
        >
          <p className="text-sm text-muted-foreground">
            ...
            {count !== 1
              ? t("productsFoundPlural", { count })
              : t("productsFound", { count })}
          </p>
          {activeCategoryName && (
            <Badge variant="emerald">{activeCategoryName}</Badge>
          )}
